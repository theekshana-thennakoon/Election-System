...
<section class="contact">
    <?php
        $sqlc = "SELECT count(id) as cid FROM register where status = 'evorppa'";
    ...
    ?>
    <h2>Approved Voters Count : <?php echo $cid ?></h2>
	<table>
        <tr>
            <th>NIC</th>
            <th>Name</th>
        ...
        <?php
            $sql = "SELECT * FROM register where status = 'evorppa' limit 6";
            ...
            if ($result->num_rows > 0){
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    <td><center>Approved</center></td></tr>";
                }
                echo $tds;
            }
            else{
                echo "<tr><td colspan = '4'><center><h2>Not Yet Approved Any Voter</h2></center></td></tr>";
            }
        ?>
    </table>
