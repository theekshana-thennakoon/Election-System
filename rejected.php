...
<section class="contact">
    <?php
        $sqlc = "SELECT count(id) as cid FROM register where status = 'tceger'";
    ...
    ?>
    <h2>Rejected Voters Count : <?php echo $cid ?></h2>
	<table>
        <tr>
            <th>NIC</th>
            <th>Name</th>
        ...
        <?php
            $sql = "SELECT * FROM register where status = 'tceger' limit 6";
            ...
            if ($result->num_rows > 0){
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    <td><center>Reject</center></td></tr>";
                }
                echo $tds;
            }
            else{
                echo "<tr><td colspan = '4'><center><h2>Not Yet Reject Any Voter</h2></center></td></tr>";
            }
        ?>
    </table>
